    ...
    <>
      ...
      <div className="well">
        ...
        <button
          className={
            "btn " +
            (plan === "price_1JG8SoG6rUbsulVXxoXBqvFH"
              ? "btn-primary"
              : "btn-outline-primary")
          }
          onClick={() => setPlan("price_1JG8SoG6rUbsulVXxoXBqvFH")}
        >
          Choose Monthly $25/m
        </button>
        ...
        <button
          className={
            "btn " +
            (plan === "price_1JG8TVG6rUbsulVXFNFOIntJ"
              ? "btn-primary"
              : "btn-outline-primary")
          }
          onClick={() => setPlan("price_1JG8TVG6rUbsulVXFNFOIntJ")}
        >
